return {
  ...
  config = function()
    ...
    local handlers = require("mvido.plugins.lsp.handlers")
    ...
    local java_cmd = "/Users/mark.vido/Library/Java/JavaVirtualMachines/openjdk-21.0.2/Contents/Home/bin/java"
